...
require (
	github.com/hwcer/cosgo v1.3.0
	github.com/hwcer/cosmo v1.1.0
	github.com/hwcer/cosnet v1.0.0
	github.com/hwcer/cosrpc v1.0.0
	github.com/hwcer/cosweb v1.0.0
	github.com/hwcer/coswss v0.0.2
	github.com/hwcer/logger v0.1.0
	github.com/hwcer/updater v1.1.0
